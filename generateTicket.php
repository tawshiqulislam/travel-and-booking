...
<?php
	...
	$bookingDataInsertSQL = "INSERT INTO `flightbookings`(username,date,cancelled,status,origin,destination,passengers,type) VALUES('$user','$dateFormatted','no','pending','$origin','$destination','$totalPassengers','$mode')";
