...
<body>
	...
	$return = preg_split('/\//', $_POST["returnHidden"]);
	$month = $return[0];
	$day = $return[1];
	$year = $return[2];
	...
	<div class="searchFlights">
		...
		<div class="query">
			...
			<?php //echo $type; 
			?> Inbound <?php echo $className; ?> flights from <?php echo $destination; ?> to <?php echo $origin; ?>
		...
		$sql = "SELECT * FROM flights WHERE origin='$destination' AND destination='$origin' AND class='$className' AND date='$return' ORDER BY seats_available DESC";
