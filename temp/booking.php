		...
		<div class="bookingWrapper">
			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="price"><span class="sansSerif">BDT </span><?php echo $adults*$row["fare"]; ?></div>
						<div class="price"><span class="sansSerif">BDT </span><?php echo $children*$row["fare"]; ?></div>
						<div class="price"><span class="sansSerif">BDT </span>250</div>
					</div>	
					...
					<div class="col-sm-4">
						<div class="priceTotal"><span class="sansSerif">BDT </span><?php echo ($adults*$row["fare"])+($children*$row["fare"])+250; ?></div>
					</div>
			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="price"><span class="sansSerif">BDT </span><?php echo $adults*($rowOutbound["fare"]+$rowInbound["fare"]); ?></div>
						<div class="price"><span class="sansSerif">BDT </span><?php echo $children*($rowOutbound["fare"]+$rowInbound["fare"]); ?></div>
						<div class="price"><span class="sansSerif">BDT </span>250</div>
					</div>	
					...
					<div class="col-sm-4">
						<div class="priceTotal"><span class="sansSerif">BDT </span><?php echo ($adults*($rowOutbound["fare"]+$rowInbound["fare"]))+($children*($rowOutbound["fare"]+$rowInbound["fare"]))+250; ?></div> <!-- CHANGE -->
					</div>
			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="price"><span class="sansSerif">BDT </span><?php echo $_SESSION["noOfRooms"]*$row["price"]*$noOfDays; ?></div>
						<div class="price"><span class="sansSerif">BDT </span>250</div>
					</div>	
					...
					<div class="col-sm-4">
						<div class="priceTotal"><span class="sansSerif">BDT </span><?php echo ($_SESSION["noOfRooms"]*$row["price"]*$noOfDays)+250; ?></div>
					</div>
			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						<div class="price"><span class="sansSerif">BDT </span><?php echo $noOfPassengers*$row[$priceClass]; ?></div>
						<div class="price"><span class="sansSerif">BDT </span>250</div>
					</div>	
					...
					<div class="col-sm-4">
						<div class="priceTotal"><span class="sansSerif">BDT </span><?php echo ($noOfPassengers*$row[$priceClass])+250; ?></div>
					</div>
