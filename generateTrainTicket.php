...
<?php
	...
	$bookingDataInsertSQL = "INSERT INTO `trainbookings`(username,date,cancelled,origin,destination,passengers,status) VALUES('$user','$dateFormatted','no','$origin','$destination','$totalPassengers','pending')";
