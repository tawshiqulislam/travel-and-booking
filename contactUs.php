...
<body>
	...
	<div class="col-xs-12 contactPadding">
		...
		if (isset($_POST["submit"])) {
			...
			$s = "insert into contact (full_name, email, message) values('$name','$email','$message')";
			mysqli_query($conn, $s);
			mysqli_close($conn);
		...
		<div class="col-sm-5 contactUsForm">
			...
			<form method="post" action="" id="contactForm">
				...
				<div class="text-center">
					<input type="submit" name="submit" class="contactButton" value="Send" />
				</div>
