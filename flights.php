...
<head>
	...
	<title>Flights | Tour&Travel</title>
						...
						<form name="flightSearch" action="returnTripOutboundFlightSearch.php" method="POST">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="origin" data-live-search="true" class="form-control" data-size="5" title="Select Origin" name="origin" required>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="destination" data-live-search="true" class="form-control" data-size="5" title="Select Destination" name="destination" required>
										<option value="Dhaka" data-subtext="DAC" data-tokens="DAC Dhaka">Hazrat Shahjalal International Airport, Dhaka</option>
										<option value="Jashore" data-subtext="JSR" data-tokens="JSR Jashore">Jashore Airport, Jashore</option>
										<option value="Barishal" data-subtext="BZL" data-tokens="BZL Barishal">Barishal Airport, Barishal</option>
										<option value="Chattogram" data-subtext="CGP" data-tokens="CGP Chattogram">Shar Amanat International Airport, Chattogram</option>
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<div class="input-group date" id="datetimepicker1">
										<input id="datetime1" type="text" class="inputDate form-control" placeholder="Select Departure Date" name="date" required />
							...
							<div class="col-sm-3">
								...
								<div class="form-group">
									<select id="adults" class="form-control" data-size="5" title="Aged 18 and above" name="adults" required>
							...
							<div class="col-sm-3">
								...
								<div class="form-group">
									<select id="children" class="form-control" data-size="5" title="Aged upto 17" name="children" required>
